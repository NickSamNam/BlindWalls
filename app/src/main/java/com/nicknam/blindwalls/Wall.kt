    ...
    companion object {
        fun extractFromJSONArray(jsonArray: JSONArray): MutableList<Wall> {
            ...
            for (i in 0 until jsonArray.length()) {
                ...
                if (jImages != null) (0 until jImages.length()).mapNotNullTo(images) { if (jImages.getJSONObject(it)["url"] as? String != null) DataManager.BASE_IMAGE_URL + (jImages.getJSONObject(it)["url"] as String).toLowerCase() else null }
